...
def intro():
    (afficher_les_messages_lentement(f"Bienvenue dans D&D, appuyez sur 'Entree' pour continuer.")) #mdr on essaye un autre truc aLORS 
    yippie = input()
    #keyboard.wait('enter')  # Attendre la touche "Entree"   uh oh j'arrive pas, je vais manger et je reviens ok?
...
def combat():
    ...
    listep = [
        Personnage("Gojo Satoru", "top tier sorcerer", typedegats[5],degatsval[typedegats[5]], 150, "", armes[2],0),
        Personnage("Dazai Osamu", "a suicidal genius", typedegats[5],degatsval[typedegats[5]], 150, "", armes[3],0),
        Personnage("Kurosaki Ichigo", "Un Shinigami", typedegats[2],degatsval[typedegats[2]],150, "", armes[1],0)
    ]
    listem = [
        Monstre("Goblin", "ugly fugly creature", typedegats[0],degatsval[typedegats[0]],10,100,  "", "Feu",0),
        Monstre("Ruin Guard", "Automated robot built ", typedegats[2],degatsval[typedegats[2]],10,100,  "", "rien",0),
        Monstre("Dabi", "Supervillain with high flame power", typedegats[3],degatsval[typedegats[3]],5,100,  "", "Feu",0)
    ]
